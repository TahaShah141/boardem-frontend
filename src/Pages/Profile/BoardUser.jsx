        ...
        <div className="p-3 bg-neutral-950 bg-opacity-20 rounded-lg border-2 border-black flex justify-between items-center">
            ...
            <div className="flex gap-1 x-sm:gap-3">
                ...
                <button className="h-10 w-10 p-2 bg-neutral-950 rounded-full x-sm:hidden" disabled={isLoading} onClick={() => kickUser()}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>account-remove</title><path d="M15,14C17.67,14 23,15.33 23,18V20H7V18C7,15.33 12.33,14 15,14M15,12A4,4 0 0,1 11,8A4,4 0 0,1 15,4A4,4 0 0,1 19,8A4,4 0 0,1 15,12M5,9.59L7.12,7.46L8.54,8.88L6.41,11L8.54,13.12L7.12,14.54L5,12.41L2.88,14.54L1.46,13.12L3.59,11L1.46,8.88L2.88,7.46L5,9.59Z" fill="currentColor"/></svg>
                </button>
            </div>
        </div>
    )
