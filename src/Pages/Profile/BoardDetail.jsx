...
export default function BoardDetail({board}) {
    ...
    <div className="flex flex-col items-center">
        ...
        {!collapsed && <div className="bg-neutral-900 p-5 w-[95%] border-t-0 border-4 border-black rounded-b-xl flex flex-col gap-3">
            {!editing && <button onClick={() => setEditing(true)} className="font-mono border-2 border-white py-2 px-4 text-sm rounded-md bg-neutral-700 hover:scale-105 x-sm:hover:scale-100 hover:font-bold hover:border-black hover:border-2 hover:bg-violet-500">Edit Board</button>}
            {editing &&
