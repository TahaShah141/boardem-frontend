...
return (
        ...
        <div className="flex flex-col gap-3">
            ...
            <div className={`text-white text-4xl text-center p-2 bg-primary rounded-xl font-mono border-4 border-black tracking-widest uppercase ${isLoading ? "animate-pulse -z-10": "animate-none"}`}>
                {!error && 
                (board && board.name) ||
                (!board && <p>loading</p>)}
